    ...
    <div class="all-grids-view overflow-content box">
        ...
        <header class="srow header" role="toolbar" v-show="graphList && graphList.length > 0">
            <div class="btn-group left">
                ...
                <a href="#settings" :aria-label="$t('settings')"><button tabindex="-1" class="spaced small"><i class="fas fa-2x fa-cog"></i><span class="hide-mobile">&nbsp;&nbsp;{{ $t('settings') }}</span></button></a>
            </div>
            ...
            <div v-if="selectedGraphElement">
                ...
                <div class="srow">
                    <div class="five columns">
                        <img :src="selectedGraphElement.grid.thumbnail ? selectedGraphElement.grid.thumbnail.data : imageUtil.getEmptyImage()" style="height: 150px; max-width: 100%;"/>
                    </div>
