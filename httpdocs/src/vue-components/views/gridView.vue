    ...
    <div class="box" id="gridView" v-cloak>
        <header class="srow header" role="toolbar" v-if="metadata" v-show="!metadata.fullscreen">
            <div class="btn-group left">
                <button tabindex="30" v-show="!metadata.locked" @click="toEditGrid()" class="small" :aria-label="$t('editingOn')"><i class="fas fa-pencil-alt"/> <span class="hide-mobile">{{ $t('editingOn') }}</span></button>
                <button tabindex="31" v-show="!metadata.locked" @click="toSettings()" class="spaced small" :aria-label="$t('settings')"><i class="fas fa-cog"></i> <span class="hide-mobile">{{ $t('settings') }}</span></button>
                <button tabindex="35" v-show="!metadata.locked" @click="toManageGrids()" class="small" :aria-label="$t('manageGrids')"><i class="fas fa-list-ul"></i> <span class="hide-mobile">{{ $t('manageGrids') }}</span></button>
...
<script>
    ...
    import {areService} from "../../js/service/areService.js";
    import {Router} from "../../js/router.js";
    import {MetaData} from "../../js/model/MetaData.js";
    import {urlParamService} from "../../js/service/urlParamService.js";

    import {Scanner} from "../../js/input/scanning.js";
    import {Hover} from "../../js/input/hovering.js";
    import {Clicker} from "../../js/input/clicking.js";
    import {DirectionInput} from "../../js/input/directionInput.js";
    import {SequentialInput} from "../../js/input/sequentialInput.js";
    ...
    import {printService} from "../../js/service/printService.js";
    import {MainVue} from "../../js/vue/mainVue.js";
    import {stateService} from "../../js/service/stateService.js";
    import { systemActionService } from '../../js/service/systemActionService.js';
            ...
            async recalculateRenderGrid(gridData) {
                ...
                if (gridData.showGlobalGrid) {
                    ...
                    this.renderGridData = gridUtil.mergeGrids(gridData, globalGrid, {
                        globalGridHeightPercentage: this.metadata ? this.metadata.globalGridHeightPercentage : 50,
                        noDeepCopy: true
                    });
                } else {
