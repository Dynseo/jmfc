    ...
    <div class="overflow-content box">
        <header class="srow header" role="toolbar">
            <div class="btn-group left">
                <a href="#main" :aria-label="$t('goBack')"><button tabindex="-1"><i class="fas fa-2x fa-home"></i><span class="hide-mobile">&nbsp;&nbsp;{{ $t('goBack') }}</span></button></a>
                <a href="#grids" :aria-label="$t('manageGrids')"><button tabindex="-1" class="spaced small"><i class="fas fa-2x fa-list-ul"></i><span class="hide-mobile">&nbsp;&nbsp;{{ $t('manageGrids') }}</span></button></a>
                <a href="#login" :aria-label="$t('changeUser')"><button tabindex="-1"><i class="fas fa-2x fa-users"></i><span class="hide-mobile">&nbsp;&nbsp;{{ $t('changeUser') }}</span></button></a>
            </div>
            <button @click="openHelp" :aria-label="$t('help')"><i class="fas fa-question-circle"></i> <span class="hide-mobile">{{ $t('help') }}</span></button>
        </header>
        <div class="srow content spaced" v-if="show">
            ...
            <div class="srow">
                <div class="eleven columns">
                    ...
                    <div>
                        <slider-input :label="'intervalForRemindingMakeBackups'" :unit="$t('days')" id="backupReminderInterval" min="0" max="100" step="1" v-model.number="metadata.notificationConfig.backupNotifyIntervalDays" @change="saveMetadata()"/>
                    </div>
                </div>
            </div>
            <div class="srow">
