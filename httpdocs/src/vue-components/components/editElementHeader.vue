<template>
    <div class="container-fluid px-0 mb-5">
        <div class="row">
            ...
            <a v-if="closeFn" id="closeLink" :title="$t('close')" class="col-2 col-sm-1 col-md black order-md-4 alignRight" href="javascript:;" @click="closeFn"><i class="fas fa-times"/></a>
