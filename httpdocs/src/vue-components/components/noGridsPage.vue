<template>
    <div class="p-4">
        ...
        <h3 class="my-3">{{ $t('chooseYourStartGrids') }}</h3>
            ...
            <ul id="boardGrid">
                <li v-for="preview in gridPreviews">
                    ...
                    <div class="preview-buttons d-flex justify-content-between">
                        ...
                        <button @click="importData(preview)"><span class="fa fa-check"/> {{ $t('useIt') }}</button>
                    </div>
                </li>
            </ul>
        </div>

        <!--*** Recherche interne de grille<div class="my-3">
