                ...
                <div class="modal-container modal-container-flex" @keydown.esc="$emit('close')" @keydown.ctrl.enter="save()">
                    <div class="container-fluid px-0 mb-5">
                        <div class="row">
                            ...
                            <a class="col-2 col-sm-1 col-md black alignRight" href="javascript:void(0);" :title="$t('close')" @click="$emit('close')"><i class="fas fa-times"/></a>
                        </div>
                    </div>
        ...
        methods: {
            ...
            save() {
                ...
                if (gridIds.length === 1 && this.selectedGrid) {
                    ...
                    filename = `${user}_${util.getCurrentDateTimeString()}_jmfc-grid-custom-backup`;
                }
