...
gridUtil.generateGlobalGrid = function (locale, options) {
    ...
    let elementHome = new GridElement({
        ...
        y: 0,
        image: new GridImage({
            author: constants.FREEPIK_AUTHOR,
            authorURL: constants.FREEPIK_URL,
            url: '/pictograms/home_13984176.svg'
        }),
    ...
    let elementBack = new GridElement({
        ...
        image: new GridImage({
            author: constants.FREEPIK_AUTHOR,
            authorURL: constants.FREEPIK_URL,
            url: '/pictograms/reload_13984475.svg'
        }),
    ...
    let elementSpeak = new GridElement({
        ...
        image: new GridImage({
            author: constants.FREEPIK_AUTHOR,
            authorURL: constants.FREEPIK_URL,
            url: '/pictograms/play_13984160.svg'
        }),
    ...
    let elementBackspace = new GridElement({
        ...
        image: new GridImage({
            author: constants.FREEPIK_AUTHOR,
            authorURL: constants.FREEPIK_URL,
            url: '/pictograms/backward_13984295.svg'
        }),
    ...
    let elementClear = new GridElement({
        ...
        image: new GridImage({
            author: constants.FREEPIK_AUTHOR,
            authorURL: constants.FREEPIK_URL,
            url: '/pictograms/delete_10336423.svg'
        }),
