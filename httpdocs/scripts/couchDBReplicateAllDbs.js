if (!process.argv[2] || !process.argv[3]) {
    ...
    console.log("----");
    console.log("Example:");
    console.log(`node couchDBReplicateAllDbs.js https://admin:admin@my.couchdb.org:6984 http://admin:admin@cdb.jemefaiscomprendre.com`);
    console.log(`All data is transferred from source to target, no changes in source.`);
    return;
}

let sourceDBUrl = process.argv[2] || 'http://admin:admin@cdb.jemefaiscomprendre.com';
let targetDBUrl = process.argv[3] || 'http://admin:admin@cdb.jemefaiscomprendre.com';
