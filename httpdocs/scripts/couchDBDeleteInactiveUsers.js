if (!process.argv[2]) {
    ...
    console.log('node couchDBDeleteInactiveUsers.js http://admin:admin@cdb.jemefaiscomprendre.com');
    return;
}

let couchUrl = process.argv[2] || 'http://admin:admin@cdb.jemefaiscomprendre.com';
