if (!process.argv[2] || !process.argv[2].trim()) {
    ...
    console.log("node couchDbCompact.js http://admin:admin@cdb.jemefaiscomprendre.com ... for just analyzing current disk usage");
    console.log("node couchDbCompact.js http://admin:admin@cdb.jemefaiscomprendre.com compact ... for compacting all databases");
    return;
}

let dbUrl = process.argv[2] || 'http://admin:admin@cdb.jemefaiscomprendre.com';
